...
$totalContentQuery = $db->prepare("SELECT * FROM products WHERE productType = 'Aksesuar' AND productSituation = '1' $menuCondition $searchCondition ORDER BY id DESC");
                ...
                <tr>
                    <td>
                        <table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr height="30">
                                        <td><a href="index.php?pageNo=87" style="text-decoration: none; <?php if($menuId == ""): ?> color: #FF0000; <?php else: ?> color: #646464; <?php endif; ?>  font-weight: bold;">&nbsp;Tüm Ürünler</a></td>
                                    </tr>
                            <?php
                                $menusQuery =  $db->prepare("SELECT * FROM menus WHERE productType = 'Aksesuar'");
                                $menusQuery->execute();
                            ...
                            ?>
                                    <tr height="30">
                                        <td><a href="index.php?pageNo=87&menuId=<?= $menu['id'] ?>" style="text-decoration: none; <?php if($menuId == $menu['id']): ?> color: #FF0000; <?php else: ?> color: #646464; <?php endif; ?>  font-weight: bold;">&nbsp;<?= backChanges($menu['menuName']) ?></a></td>
                                    </tr>
                            <?php
                                }
                            ?>
                ...
                <tr>
                    <td>
                        <div class="searchArea">
                            <form action="<?php if($menuCondition != ""): ?>index.php?pageNo=87&menuId=<?= $menuId ?><?php else: ?>index.php?pageNo=87<?php endif; ?>" method="post">
                    ...
                    <td>
                        <table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ÜRÜNLERİ LİSTELE
                                <?php
                                $productsQuery = $db->prepare("SELECT * FROM products WHERE productType = 'Aksesuar' AND productSituation = '1' $menuCondition $searchCondition ORDER BY id DESC LIMIT $initialContentOfPagination, $contentPerPage");
                            ...
                            ?>
                                        <td width="191" valign="top">
                                            <table width="191" align="left" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #A0A0A0; margin-bottom: 20px;">
                                                <tr height="40">
                                                    <td align="center"><a href="index.php?pageNo=82&id=<?= backChanges($product['id']) ?>"><img src="pictures/products/Aksesuar/<?php echo $product["productPic1"]; ?>" border="0" width="185" height="247"></a></td>
                                                </tr>
                                                <tr height="25">
                                                    <td width="191" align="center"><a href="index.php?pageNo=82&id=<?= backChanges($product['id']) ?>" style="color: #FF0000; font-weight: bold; text-decoration: none;">Aksesuar</a></td>
                                                </tr>
                                                <tr height="25">
                                ...
                                <td align="center" colspan="8">
                                    <div class="pagination">
                                        ...
                                        <div class="totalPageNumber">
                                            <?php
                                                if($pagination > 1){
                                                    echo '<span class="paginationPassive"><a href="index.php?pageNo=87' . $paginationCondition . '&pagination=1"><<</a></span>';
                                                    $back = $pagination - 1;
                                                    echo '<span class="paginationPassive"> <a href="index.php?pageNo=87' . $paginationCondition . '&pagination='. $back . '"><</a> </span>';
                                                }
                                                for($i = $pagination - $paginationCount; $i <= $pagination + $paginationCount; $i++){
                                                    if(($i > 0) && ($i <= $totalPage)){
                                                        if($pagination == $i){
                                                            ...
                                                            echo '<span class="paginationPassive"> <a href="index.php?pageNo=87' . $paginationCondition . '&pagination='. $i .'">'. $i .'</a></span>';
                                                        }
                                                    }
                                                }
                                                if($pagination != $totalPage){
                                                    $forward = $pagination + 1;
                                                    echo '<span class="paginationPassive"> <a href="index.php?pageNo=87' . $paginationCondition . '&pagination='. $forward .'">></a> </span>';
                                                    echo '<span class="paginationPassive"> <a href="index.php?pageNo=87' . $paginationCondition . '&pagination='. $totalPage .'">>></a> </span>';
                                                }
                                            ?>
                                        </div>
                                    </div>
