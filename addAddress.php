...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td width="600" valign="top">
            <form action="index.php?pageNo=71" method="post">
                <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height="30">
                        <td valign="top" align="left"><input type="text" name="address" class="InputAlanlari"></td>
                    </tr><tr height="30">
                        <td valign="bottom" align="left">İl (*)</td>
                    </tr>
                    <tr height="30">
                        <td valign="top" align="left"><input type="text" name="city" class="InputAlanlari"></td>
                    </tr>
                    </tr><tr height="30">
                        <td valign="bottom" align="left">İlçe (*)</td>
                    </tr>
                    <tr height="30">
                        <td valign="top" align="left"><input type="text" name="country" class="InputAlanlari"></td>
                    </tr>
                    <tr height="30">
                    ...
                    <tr height="50">
                        <td align="center"><input type="submit" value="Adres Ekle" class="YesilButton"></td>
                    </tr>
                </table>
            </form>
        </td>
